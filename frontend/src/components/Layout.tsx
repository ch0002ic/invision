              ...
              <div className="flex items-center gap-4 mt-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="min-w-[120px] px-0 py-1">
                    <DropdownMenuItem className="px-4 py-1 text-left cursor-pointer">Profile</DropdownMenuItem>
                    <DropdownMenuItem className="px-4 py-1 text-left cursor-pointer">Settings</DropdownMenuItem>
                    <DropdownMenuItem className="px-4 py-1 text-left cursor-pointer" onClick={handleLogout}>Logout</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              </div>
            </header>
